...
- **🚀 Rapid Prototyping**: Learn to quickly test hypotheses and build MVPs with modern tech stack
- **🧪 Automated Testing**: Every lab includes comprehensive testing with CI/CD pipelines
- **📹 Complete Recordings**: All lectures and labs recorded in dual format (screen + front camera)
- **👥 Peer Review System**: Real-world code review workflow with peer feedback
- **⚡ Fast-Track Option**: Pass the entire course by completing one comprehensive project

## 🎯 Course Overview
* **Backend (Go)** – REST APIs, PostgreSQL, gRPC, micro-services  
* **Frontend (Flutter)** – cross-platform UI, Riverpod, gRPC/HTTP clients  
* **DevOps** – Docker, GitHub Actions, CI/CD  
* **Software Engineering** – Clean Architecture, TBD, code review, testing, documentation, teamwork
...
### **[YouTube playlist](https://youtube.com/playlist?list=PLz1kbB-Ej5hVeiGoio9yXzpinvjpD6vvH)** of lectures and labs
### **[VK Video playlist](https://vkvideo.ru/playlist/510621648_3)** of lectures and labs
...
|:---:|---|---|---|---|
| 1 | **Foundations** | syntax, structs | widgets, layout | — |
...
Students can pass the full course by completing a comprehensive project covering all 8 blocks. Requirements are detailed in [docs/fast-track/tech-requirements.md](docs/fast-track/tech-requirements.md).

**Fast-Track Projects:**
- [olesia8novoselova](https://github.com/olesia8novoselova/sum25-go-flutter-course) 
- [HealthySummer](https://github.com/Troshkins/HealthySummer) 
- [ffabious](https://github.com/ffabious/healthy-summer) 
- [SachaYT1](https://github.com/SachaYT1/Fast-track-project)
...
│   ├── lab01/                 # Lab 1: Foundations
│   ├── lab02/                 # Lab 2: Real-time Chat (Concurrency & Streams)
│   ├── lab03/                 # Lab 3: REST API Chat System (Data & APIs)
│   ├── lab04/                 # Lab 4: Database & Persistence
│   ├── lab05/                 # Lab 5: Advanced Patterns (Auth & Security)
│   ├── lab06/                 # Lab 6: gRPC Microservices & WebSocket Communication
│   └── lab07/                 # Lab 7: CI/CD, Docker, and Deployment
├── slides/                     # Course presentation materials
│   ├── lecture00/             # Course introduction
│   ├── lecture01/             # Lecture 1: Foundations
│   ├── lecture02/             # Lecture 2: Concurrency & Streams
│   ├── lecture03/             # Lecture 3: Data & APIs
│   ├── lecture04/             # Lecture 4: Database & Persistence
│   ├── lecture05/             # Lecture 5: Advanced Patterns
│   ├── lecture06/             # Lecture 6: Communication & Microservices
│   └── lecture07/             # Lecture 7: CI/CD & Deployment
├── docs/                       # Documentation
│   ├── fast-track/            # Fast-track project requirements
│   ├── final-project/         # Final project guidelines
│   ├── peer-review/           # Peer review assignments & guidelines
│   └── submission/            # Submission workflow documentation
├── feedback/                   # Course feedback and analytics
│   ├── data/                  # Survey data
│   ├── figures/               # Generated charts
│   ├── images/                # Course images
│   └── scripts/               # Feedback analysis scripts
...
![Overall Impressions](feedback/figures/overall_impressions.png)
...
![Feel After Talk](feedback/figures/feel_after_talk.png)
...
![Course Compare](feedback/figures/course_compare.png)
...
![Help Received](feedback/figures/help_received.png)
...
### Raw Data Access
For detailed analysis, the complete feedback data is available in [JSON format](feedback/data/final_feedback.json).

---

## 📸 Group Photo
![Group Photo](feedback/images/group_photo.png)
